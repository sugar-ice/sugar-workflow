...
public class LeaveServiceImpl extends ServiceImpl<LeaveMapper, Leave> implements LeaveService {
    ...
    public Result listPage(LeaveREQ req) {
        ...
        MPJLambdaWrapper<Leave> wrapper = new MPJLambdaWrapper<Leave>()
                .selectAll(Leave.class)
                .selectAll(BusinessStatus.class)
                .leftJoin(BusinessStatus.class, BusinessStatus::getBusinessKey, Leave::getId)
                .eq(Leave::getUsername, req.getUsername())
                .like(!StringUtils.isEmpty(req.getTitle()), Leave::getTitle, req.getTitle())
                .eq(req.getStatus() != null, BusinessStatus::getStatus, req.getStatus())
                .orderByDesc(Leave::getCreateDate);
        IPage<Leave> page = baseMapper.selectJoinPage(req.getPage(), Leave.class, wrapper);
